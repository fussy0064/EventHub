...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '' || !filter_var($email, FILTER_VALIDATE_EMAIL) || $password === '') {
        ...
        if (User::findByEmail($db, $email) !== null) {
            ...
            // Organizers require admin approval before they can log in
            if ($role === 'organizer') {
            ...
            if ($user->save()) {
                if ($role === 'organizer') {
                    app_set_flash('success', 'Account created successfully. Your organizer account is pending admin approval. You will be able to sign in once approved.');
                } else {
